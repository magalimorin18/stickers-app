...
function Leaderboard() {
  ...
  const leaderboardData: LeaderboardEntry[] = [
    {
      rank: 1,
      username: "CampeonSticker",
      score: 1500,
      imageUrl:
        "https://contenthub-static.crypto.com/wp_media/2024/03/What-is-PEPE_F2.jpg",
    },
    {
      rank: 2,
      username: "ReyDelSticker",
      score: 1400,
      imageUrl:
        "https://contenthub-static.crypto.com/wp_media/2024/03/What-is-PEPE_F2.jpg",
    },
          ...
          {leaderboardData.map((entry) => (
            ...
            >
              <td style={tableCellStyle}>
                {renderTrophy(entry.rank)} {entry.rank}
              </td>
              <td style={tableCellStyle}>
                {entry.imageUrl && (
                  <img
